        ...
        <Sidebar>
          <div className="p-2 md:p-2">
            <div className=" mx-auto mt-10">
              <div className="wrapper bg-white rounded shadow w-full">
                <div className="header flex justify-between border-b p-2">
                  <span className="text-lg font-bold">2022 May</span>
            ...
            <div className="md:px-10 py-5">
              <div>
                <button className="shadow-lg bg-[#ffffff] text-black font-bold px-6 py-2 rounded-lg border hover:bg-transparent hover:text-[#040404E0]">
                  <div className="flex">
                    Upload
                    <svg
                      className="w-6 h-6"
